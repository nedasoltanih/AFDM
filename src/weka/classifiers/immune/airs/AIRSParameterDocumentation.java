...
public interface AIRSParameterDocumentation
{
	...
	//{added by neda
	public final static String PARAM_DIST =
		"Distance Function. " +
		"Specifies the distance function which is used in affinity and ";
	
	public final static String PARAM_UPDATE =
		"Update. " +
		"Specifies if in the test stage update will be done or not.";
	
	public final static String PARAM_NEGSEL =
		"Negative Selection. " +
		"Specifies if in the train stage Negative Selection will be used or not.";
	
	public final static String PARAM_USER =
		"User Specific Cells. " +
		"Specifies if in detectors are user specified or not.";
	//added by neda}
